...
public class WebAppController {
    ...
    @Value("${pubsub.votes.topic-id}")
    private String votesTopicId;

    @Value("${pubsub.votes.subscription-id}")
    private String votesSubscriptionId;

    public WebAppController() {
        //Subscribe for votes
        System.out.println("Subscribing for votes topic");
    ...
    @RequestMapping("/publish/results/{electionId}")
    public void publishResults(@RequestBody String sampleJsonMessage)
            throws InterruptedException, IOException, ExecutionException {
            System.out.println("Resulrs declared");
//        TopicName topicName = TopicName.of(projectId, topicId);
//
//        Publisher publisher = null;
//
